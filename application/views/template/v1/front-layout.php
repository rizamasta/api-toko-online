...
<html lang="en">
    ...
    <head>
        ...
        <!-- Only this layout / front-layout -->
        <link href="<?php echo site_url('public_assets/assets/js/landingpage/css/layout-custome-front.css')?>" rel="stylesheet" type="text/css">
    ...
    <body id="body" data-spy="scroll" data-target=".header" class="page-on-scroll">
        <!--========== HEADER ==========-->
        <?php include($includes.'header-landingpage-front.php')?>
        <!--========== END HEADER ==========-->
